<div class="footer-area">
    <img class="hero-shape shape-1 footer-shape-1" src="assets/images/hero-animation-round-1.png" alt="">
    <img class="hero-shape footer-shape-2" src="assets/images/footer-animation-round-1.png" alt="">
    <img class="hero-shape shape-3 footer-shape-3" src="assets/images/hero-animation-round-3.png" alt="">
    <img class="hero-shape shape-4 footer-shape-4" src="assets/images/hero-animation-round-3.png" alt="">
    <div class="container">
        <div class="row">
        ...
        <div class="row contact-address-info-wrap">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="footer-title text-lg-center">
                    <h4>Contact Us:</h4>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div class="contact-address-info">
                    ...
                    <div class="address-content">
                        <span>Unit A6 Oxgate Lane, London, NW2 7HJ, UK</span>
                    </div>
                </div>
            </div>
        </div>
