...
<head>
    ...
    <title>Excceedder | Account Email Address Update</title>
    ...
    <div class="main-body">
        <div class="content">
            ...
            <div class="content-body">
                ...
                <p class="message">
                    It appears that you have requested to change the email address associated with your account. No worries, we've got you covered! To update your email address, simply click on the verify email address button below to complete the account update process:
                </p>

                <div class="btn-div">
                    <a href="{EMAIL_UPDATE_URL}" target="_blank" class="button-link">Verify Email Address</a>
                </div>

                <p class="message">
                    After clicking the button, your email will be automatically updated to the one entered in the email address update form. Additionally, you can continue using our services without any disruptions. If you have any questions or concerns, please don't hesitate to reach out to our support team at <a href="mailto:info@excceedder.com" title="Excceedder" class="text-blue">info@excceedder.com</a>.
                </p>

                <hr class="hr-style">

                <p class="message">
                    <b>P.S.</b> If you did not initiate this account update or if you received this email in error, please ignore this message. At Excceedder, we take the security and privacy of our users very seriously, and we want to ensure that the personal information of our users is always protected.
                </p>
