...
<head>
    ...
    <title>Excceedder | Successful Recovery</title>
    ...
    <div class="main-body">
        <div class="content">
            ...
            <div class="content-body">
                ...
                <p class="message">
                    We have recently detected a change in the password associated with your account. If you suspect any unauthorized activity or changes, please immediately contact our support team. We take account security seriously and will assist you in resolving any concerns you may have. Take a moment to log in to your account using the button provided below:
                </p>
