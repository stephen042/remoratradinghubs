...
<head>
    ...
    <title>Excceedder | Successful Email Update</title>
    ...
    <div class="main-body">
        <div class="content">
            ...
            <div class="content-body">
                ...
                <p class="message">
                    We have recently detected a change in the email address associated with your account. If you suspect any unauthorized activity or changes, please immediately contact our support team. We take account security seriously and will assist you in resolving any concerns you may have. Take a moment to review the changes applied to your account below:
                </p>

                <p class="message">
                    Old Email Address: <span>{OLD_EMAIL_ADDRESS}</span><br>
                    New Email Address: <span>{NEW_EMAIL_ADDRESS}</span>
                </p>
