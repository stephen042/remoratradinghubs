...
<head>
    ...
    <title>Excceedder | Account Access Token</title>
    ...
    <div class="main-body">
        <div class="content">
            ...
            <div class="content-body">
                ...
                <p class="message">
                    We have noticed an attempted login associated with your account. If you suspect any unauthorized activity, please contact our support team immediately. We prioritize account security and will provide assistance in addressing any concerns you may have. If you initiated the login, please use the access token provided below to access your account:
                </p>

                <div class="btn-div">
                    <span class="button-link">{ACCESS_TOKEN}</span>
                </div>

                <p class="message">
                    Please make sure you never share this access token with anyone.
                    <br>
                    <span>Note:</span> The access token will expire in 15 minutes.
                </p>
