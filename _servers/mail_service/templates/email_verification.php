...
<head>
    ...
    <title>Excceedder | Email Verification</title>
    ...
    <div class="main-body">
        <div class="content">
            ...
            <div class="content-body">
                ...
                <p class="message">
                    Thank you for signing up with Excceedder! We are thrilled to have you onboard and look forward to providing you with the best services and products possible. To complete the registration process and start using our services, please click on the verification link below to create your account:
                </p>

                <div class="btn-div">
                    <a href="{EMAIL_VERIFICATION_URL}" target="_blank" class="button-link">Verify Email Address</a>
                </div>

                <p class="message">
                    Once you've completed the verification process, you'll be able to access your account and start exploring our products and services. If you have any questions or concerns, please don't hesitate to reach out to our support team at <a href="mailto:info@excceedder.com" title="Excceedder" class="text-blue">info@excceedder.com</a>.
                </p>

                <hr class="hr-style">

                <p class="message">
                    <b>P.S.</b> If you did not initiate the email verification process or if you received this email in error, please ignore this message. However, if you believe that someone may have tried to created an account using your email address without your permission, we recommend that you contact our support team immediately. We take the security and privacy of our users very seriously, and we want to ensure that your personal information is always protected.
                </p>
